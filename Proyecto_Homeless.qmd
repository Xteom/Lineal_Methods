...
first_stage_model <- lm(Actual_CoC_Median_Rent ~ Previous_CoC_Neighbor_Median_Rent + 
                        CoC_AVG_Median_Household_Income + CoC_Population_Estimate + 
                        Poverty_Percentage + CoC_Civilian_Labor_Force + Unemployment_Rate + Vote_Percentage + 
                        CoC_Poverty_Estimate_Age_0_17 + Birth_Rate + Death_Rate + International_Migration_Rate + 
